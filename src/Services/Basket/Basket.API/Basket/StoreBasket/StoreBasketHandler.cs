...
{    
    ...
    {
        //communicate with discount.grpc y calcular ultimos precios del producto, obtengo el precio del cupon x producto y lo resto al precio actual del item del carrito de compras
